...
author: CausalSpark Engineering
date: 2026-04-20
version: 0.4.2
status: draft
tags:
  ...
  - policy
description: >
  Defines the symbolic governance layer for CausalSpark's intervention
  policy engine. Specifies ontology classes, SHACL validation constraints,
  inference queries, and the boundary contract with the sub-symbolic SNN layer.
---
